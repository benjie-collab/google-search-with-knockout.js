...
$(function(){
	...
	if($("#my-dropzone").length > 0) {
		//myDropzone = new Dropzone("#my-dropzone", {url: "http://templates.expresspixel.com/bootlistings/js/test.php", autoProcessQueue:false});
	}
    
    $(document)
        .on('change', '.btn-file :file', function() {
            $('#file-select').attr('src', 'loading.png'/*tpa=http://templates.expresspixel.com/bootlistings/js/css/images/loading.png*/);
            var input = $(this),
    ...
    $( document ).on( "click", "#regionsBtn", function() {
